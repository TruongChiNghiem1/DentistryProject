...
(function(l) {
    ...
    function Ob(a) {
        var b = a.oClasses,
            ...
            e = a.oPreviousSearch,
            h = a.aanFeatures,
            f = '<div class="serach_field_2"><div class="search_inner"><div class="search_field"><input type="search" placeholder="Search content here..."></div><button type="submit"> <i class="ti-search"></i> </button></div> </div>',
            g = d.sSearch;
