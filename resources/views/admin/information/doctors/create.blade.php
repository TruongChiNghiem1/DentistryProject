...
@section('content')
<form action="{{ route('admin.information.doctors.store') }}" method="post"  enctype="multipart/form-data">
    <table>
        @csrf
                    ...
                    <div class="white_box mb_30 col-lg-12">
                        <div class="box_header">
                            <div class="main-title">
                                <h3 class="mb-0">Điền thông tin bác sĩ</h3>
                            </div>
                        </div>
                        <div>
                        ...
                        <div class="d-flex justify-content-between">
                            <div class="col-lg-6" >
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    <input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="doctor_name" value="{{ old('doctor_name') }}">
                                </div>
                            </div>
                            <div class="col-lg-2">
                            ...
                            <div class="col-lg-3">
                                <div class="input_wrap common_date_picker mb_20">
                                    ...
                                    <input class="input_form" id="start_datepicker" type="date" placeholder="Pick a start date" name="doctor_birth" value="{{ old('doctor_birth') }}">
                                </div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-between">
                            <div class="col-lg-6">
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    <input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" name="doctor_phone" value="{{ old('doctor_phone') }}">
                            ...
                            <div class="col-lg-3">
                                ...
                                <div class="input-group input-group-sm mb-3">
                                    <select class="form-control" id="exampleFormControlSelect1" name="position">
                                        <option value="1" {{ old('position') == 1 ? 'selected' : '' }}>Tiến sĩ</option>
                                        <option value="2" {{ old('position') == 2 ? 'selected' : '' }}>Thạc sĩ</option>
                                        <option value="3" {{ old('position') == 3 ? 'selected' : '' }}>Bác sĩ</option>
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="input-group input-group-sm d-block">
                                <textarea type="text" class="form-control ckeditor_height" aria-label="Small"  cols="30" rows="500" aria-describedby="inputGroup-sizing-sm" name="decription">{{ old('decription') }}</textarea>
                                <script>
